...
module.exports = function addContextApi(app) {
  ...
  app.post('/v2/context/challenge/reject', async (req, res) => {
    let body = req.body
    ...
    try {
      ...
      const query1 = getChallengeQuery(playerID, opponentID, 'none')
      const query2 = getChallengeQuery(opponentID, playerID, 'rejected')
